package me.fodded.mainlobby.gameplay.commands;
...
public class SetLobbyCommand extends PluginCommand {
    ...
    public void onCommand(CommandSender sender, String[] args) {
        ...
        FileConfiguration config = ConfigLoader.getInstance().getConfig("mainlobby.yml");
        ...
        ConfigLoader.getInstance().saveConfig(config, "mainlobby.yml");
