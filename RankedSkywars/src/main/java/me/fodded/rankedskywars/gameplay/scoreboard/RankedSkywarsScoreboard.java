package me.fodded.rankedskywars.gameplay.scoreboard;
...
public class RankedSkywarsScoreboard extends AbstractScoreboard {

    public RankedSkywarsScoreboard(UUID uniqueId) {
        super(uniqueId);
    }
